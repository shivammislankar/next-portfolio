  ...
  return (
    <section id="simulations" className="py-20">
      <h1 className="heading">
        Job <span className="text-purple">Simulations</span>
      </h1>

      <div className="mt-10 flex flex-wrap items-center justify-center gap-x-48 gap-y-48 p-48">
        {simulations.map(({ id, company, role, platform, link }) => (
          <div
            key={id}
           className="
           flex h-[10rem] w-[10vw] items-center justify-center sm:w-[400px]shadow-[0_0_50px_rgba(139,92,246,0.2)]
